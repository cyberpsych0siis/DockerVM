...
export class RdpTraefikProvider extends LabelProvider {
  /**
   *
  ...
  getProperties(containerName, reachableAddress) {
    return {
      ...
      Labels: {
        ...
        ["traefik.tcp.routers." + containerName + ".tls.certresolver"]:
          "sslresolver",
        ["traefik.tcp.routers." + containerName + ".rule"]:
          "HostSNI(`" + reachableAddress + "`)",
        ["traefik.tcp.services." + containerName + ".loadbalancer.server.port"]:
          "3389",
      },
    };
  }
